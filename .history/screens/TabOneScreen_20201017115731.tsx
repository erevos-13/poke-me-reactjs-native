...
import { POKEMON_START_LOADING_LIST, POKEMON_START_LOADING_LIST_SAGA } from "../store/actions/pokemon";
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    dispatch({ type: POKEMON_START_LOADING_LIST_SAGA });
  ...
  const onPressLearnMore =() => {
    console.log('[Press button]', pokemons)
  }
